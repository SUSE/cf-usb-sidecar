...
then
    ...
    then
        ...
        docker images | grep ${DOCKER_IMAGE} | awk '{print $3}' | xargs -L 1 docker rmi -f
    else
    ...
    then
       ...
       docker images | grep ${DOCKER_IMAGE} | grep ${DOCKER_IMAGE_TAG} | awk '{print $3}' | xargs -L 1 docker rmi -f
    else
